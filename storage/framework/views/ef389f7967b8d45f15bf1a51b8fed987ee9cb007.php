        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="da_id">
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary">Захиалга цуцлах</button>
                </div>
            </div>
        </div>
    </div>
                                        ...
                                        <?php if($appointment = $shift->appointments->where('start', 9+$i)->first()): ?>
                                            <td height="90px" rowspan="<?php echo e($appointment->end - $appointment->start); ?>">
                                                <button class="btn btn-primary btn-block text-left"
                                                        onclick="deleteAppointment('<?php echo e($appointment->name); ?>', '<?php echo e($appointment->phone); ?>', '<?php echo e($appointment->start); ?>:00 - <?php echo e($appointment->end); ?>:00', '<?php echo e($appointment->id); ?>', '<?php echo e($shift->doctor->name); ?>')"
