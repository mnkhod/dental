								...
								<form method="POST" action="{{ route('register') }}">
									...
									<div class="form-group row my-4">
										...
										<div class="col-md-6">
											...
											<div class="form-check">
											  <input class="form-check-input" type="radio" name="doctor" id="doctor" value="2">
											  <label class="form-check-label" for="doctor">
													Doctor
											  </label>
											</div>
											<div class="form-check">
											  <input class="form-check-input" type="radio" name="assistant" id="assistant" value="3">
											  <label class="form-check-label" for="assistant">
													Assistant
											  </label>
											</div>
											<div class="form-check">
											  <input class="form-check-input" type="radio" name="accountant" id="accountant" value="4">
